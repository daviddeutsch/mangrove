...
.config(
	...
	function ($stateProvider, $urlRouterProvider) {
	 ...
	 $stateProvider
		.state('repository', {
			abstract:true,
			templateUrl:"components/com_mangrove/templates/repositories.html"
			})
		...
		.state('repository.detail', {
			...
			templateUrl:"components/com_mangrove/templates/repository.html"
		})
		.state('package', {
			abstract:true,
			templateUrl:"components/com_mangrove/templates/packages.html",
			data:{
				search:''
			}
		})
		...
		.state('package.detail', {
			...
			templateUrl:"components/com_mangrove/templates/package.html"
		})
	}
	]
)
